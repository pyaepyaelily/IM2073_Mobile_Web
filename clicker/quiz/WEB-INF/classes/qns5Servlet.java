...
@WebServlet("/stats")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
public class qns5Servlet extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try (
         ...
         if (ids != null) {
            String sqlStr;
            int count;
            sqlStr = "INSERT INTO currentqnstable (qnsID) VALUES (6)";
            //sqlStr = "DELETE FROM currentqnstable WHERE qnsID = 5";
