...
--
-- Table structure for table `currentqnstable`
--

DROP TABLE IF EXISTS `currentqnstable`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `currentqnstable` (
  `qnsID` int NOT NULL,
  PRIMARY KEY (`qnsID`)
...
LOCK TABLES `currentqnstable` WRITE;
/*!40000 ALTER TABLE `responsetable` DISABLE KEYS */;
INSERT INTO currentqnstable (qnsID) VALUES (7);
